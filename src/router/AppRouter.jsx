...
import { ROLES, FACILITY_USER_ROLES } from '../config/constants';
...
function RoleRouter() {
  ...
  // struttura, referente qualità, responsabile HACCP) → smista per numero di strutture
  if (FACILITY_USER_ROLES.includes(role)) {
