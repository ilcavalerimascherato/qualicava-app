          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { label: 'Alta gravità',  value: stats.altaGravita, color: 'text-orange-600',  bg: 'bg-orange-50'  },
              ].map(s => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <StatCard title="Per severità"             data={stats.bySeverity} cfg={{ Bassa: { label:'Bassa', color:'bg-slate-400' }, Media: { label:'Media', color:'bg-amber-400' }, Alta: { label:'Alta', color:'bg-orange-500' } }} />
              <StatCard title="Per tipologia"            data={stats.byTipologia} />
